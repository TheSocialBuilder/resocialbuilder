class Office
  ...
  belongs_to :market
  has_many :office_listing, class_name: "Listing", inverse_of: :office
  # has_many :agents
  embeds_one :location, store_as: "location", as: :locatable, :cascade_callbacks => true


  attr_accessible :internal_office_id, :internal_office_nrds_id, :name, :phone, :email, :internal_office_short_id, :active, :last_updated, :market_attributes, :location_attributes

  # attr_accessible :location
  accepts_nested_attributes_for :location, :market
